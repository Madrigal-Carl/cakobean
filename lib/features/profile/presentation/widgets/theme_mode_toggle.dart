...
class ThemeModeToggleButton extends ConsumerWidget {
  ...
  (IconData, String) _display(ThemeMode mode) {
    switch (mode) {
      case ThemeMode.light:
        return (Icons.light_mode_outlined, 'Light mode');
      case ThemeMode.dark:
        return (Icons.dark_mode_outlined, 'Dark mode');
      case ThemeMode.system:
        return (Icons.brightness_auto_outlined, 'Device default');
    }
  }
